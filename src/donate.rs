...
pub fn Donate() -> impl IntoView {
    ...
    view! {
        <div class="px-2 flex flex-col gap-2">
            ...
            <div class="w-full">
                "This is parcel_ch, the developer working on pyon3d. "
            ...
            <div class="w-full">
                ...
                "If you have any info about that kind of stuff, you can contact me on bsky (I will set up an email at some point)"
            </div>
            <div class="w-full">
